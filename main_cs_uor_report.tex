...
\begin{document}
    ...
    \begin{titlepage}      
        \begin{center}
            ...
            \linespread{1.2}\huge {
                ...
                A comparison environmental impact of Electric and Petrol cars
            ...
            {\large 
                ...
                \emph{Supervisor:} Lily Sun}\\[1cm] % if applicable
    ...
    I,
    %%%%%%%%%%%%%%%%%%%%%%%
     Jumar Quinio Mesicias, % Mandatory part
    %%%%%%%%%%%%%%%%%%%%%%%
