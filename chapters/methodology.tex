...
A quantitative data analysis approach was adopted, using real-world datasets from
...
as Tableau are used to present key findings. This methodology ensures a comprehensive
evaluation of the environmental trade-off between petrol and electric cars.
